...
public class SecondRegisterActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fullName = intent.getStringExtra(RegisterActivity.USER_FULLNAME);
        nsuID = intent.getStringExtra(RegisterActivity.USER_NSUID);
        nsuMail = intent.getStringExtra(RegisterActivity.USER_NSUMAIL);
        phoneNumber = intent.getStringExtra(RegisterActivity.USER_PHONENUMBER);
